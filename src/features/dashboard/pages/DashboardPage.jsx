    ...
    >
      <div className="space-y-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <Card
            hover={false}
            className="p-6 rounded-3xl shadow-sm relative overflow-hidden flex flex-col justify-between"
          >
            <div className="flex justify-between items-start z-10 relative">
              <div>
                ...
                <p className="text-[10px] uppercase tracking-widest opacity-50 mt-1">
                  {goalWindowStart ? formatDateDisplay(goalWindowStart) : "TBD"} to{" "}
                  {goalWindowEnd ? formatDateDisplay(goalWindowEnd) : "TBD"}
                </p>
              </div>
            ...
            <div className="flex items-end mt-4 relative z-10">
              ...
              <div>
                <div className="flex items-baseline gap-1">
                  ...
                  {goal?.targetCount > 0 ? (
                    <p className="text-xs opacity-30 font-bold">/ {goal.targetCount}</p>
                  ) : null}
                </div>
