  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border-t border-gray-500/10 pt-6 mt-4">
      <div className="space-y-6">
        <div>
          <h3 className="font-bold text-[10px] uppercase tracking-widest opacity-50 mb-2">About</h3>
        ...
        <div>
          ...
          <div className="space-y-2 text-xs opacity-80 font-mono wrap-break-word">
        ...
        <div className="p-6 rounded-3xl border flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 relative overflow-hidden border-gray-100 bg-gray-50 dark:border-zinc-800 dark:bg-zinc-900/50">
          <div className="z-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="text-3xl font-mono font-bold tracking-tighter">{currentCount}</div>
                <p className="text-[10px] uppercase tracking-widest opacity-50">Successful</p>
              </div>
              <div>
